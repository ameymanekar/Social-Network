...
@app.route('/viewpro3', methods=['POST', 'GET'])
def viewpro3():
    if request.method == 'POST':
        ...
        return render_template('viewpro3.html', result=result ,result2=result2)
        db.close()
    return render_template('viewpro3.html')
    ...
    if request.method == 'POST':
        ...
        if cursor.rowcount:
            ...
            for row in result:
                pass2 = row[4]
                user1 = row[1]
            msg = Message('Social Network', sender='ameymanekar12@gmail.com', recipients=[f1])
